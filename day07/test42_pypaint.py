...
class WinApp(QWidget):
    ...
    def initUI(self): # 화면 초기화
        ...
        uic.loadUi('C:/Sources/basic-python-2024/day07/pyPaint.ui', self) # 실행파일 생성 시는 절대경로 사용
        # self.setWindowIcon(QIcon('./images/iot.png')) 
        self.setWindowIcon(QIcon('C:/Sources/basic-python-2024/day07/iot.png')) # 실행파일 생성 시는 절대경로 사용
    ...
    def btnLoadClicked(self):
        ...
        imagePath = image[0]
        # print(imagePath)
        pixmap = QPixmap(imagePath).scaledToWidth(381) # 파일 경로에 있는 이미지를 읽어서 pixmap객체에 담기
