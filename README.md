...
- 파이썬 응용
    ...
    ![쓰레드예제](https://raw.githubusercontent.com/LEUNSU/basic-python-2024/main/images/python_003.gif)
    ...
    class qtwin_exam(QWidget):  # UI 스레드
        ...
        # 스레드에서 시그널이 넘어오면 UI처리를 대신 해 주는 부분 슬롯함수
...
- 파이썬 응용
    - 객체지향 정리
        - 상속, 오버라이딩(재정의), 오버로딩(같은 이름의 함수를 마음대로 골라쓰는)
    - 가상환경 Virtualenv
        - 다른 버전의 파이썬도 설치해야 사용 가능
        - 현재 3.11에서 3.9 버전 가상환경 만들려면 3.9 파이썬 설치 필요
    - PyQt5와 응용예제 연습
        - 이미지 뷰어
        - 이미지 에디터

    ![PyQt예제](https://raw.githubusercontent.com/LEUNSU/basic-python-2024/main/images/python_004.png)
